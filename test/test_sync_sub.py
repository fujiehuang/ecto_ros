...
subs = dict(
            image=ImageSub(topic_name='/camera/color/image_raw', queue_size=0),
            depth=ImageSub(topic_name='/camera/depth/image_rect_raw', queue_size=0),
            depth_info=CameraInfoSub(topic_name='/camera/depth/camera_info', queue_size=0),
            image_info=CameraInfoSub(topic_name='/camera/color/camera_info', queue_size=0),
         )
